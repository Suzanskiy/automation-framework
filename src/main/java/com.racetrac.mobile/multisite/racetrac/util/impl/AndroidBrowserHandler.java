...
public class AndroidBrowserHandler extends BaseFlow implements ChromeBrowserHandler {
    ...
    private static final String ANDROID_FUEL_VIP_REDIRECT_DESIRED_URL_ACTIVE_SUBSCRIPTION = "https://punwebappqa.azurewebsites.net/Rewards/RaceTrac-Rewards-Vip?utm_source=app&utm_medium=VIPtab&utm_campaign=vip";
    private static final String ANDROID_BECOME_A_VIP_LEARN_MORE_LINK = "https://punwebappqa.azurewebsites.net/Rewards/Purchase/FuelSubscription/14?utm_source=app&utm_medium=onboarding&utm_campaign=vip";
    private static final String ANDROID_BECOME_A_VIP_GET_STARTED_LINK = "https://punwebappqa.azurewebsites.net/Rewards/Purchase/FuelSubscription/14?utm_source=app&utm_medium=onboarding&utm_campaign=vip";
