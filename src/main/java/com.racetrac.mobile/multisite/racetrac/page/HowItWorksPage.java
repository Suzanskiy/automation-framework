...
public class HowItWorksPage extends PointsAndLevelsPage {
    ...
    private WebElement scanLogoDescription;
    ...
    private WebElement earnLogoDescription;
    ...
    private WebElement redeemLogoDescription;
