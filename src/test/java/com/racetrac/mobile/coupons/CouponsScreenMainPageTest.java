...
public class CouponsScreenMainPageTest extends BaseTest {
  ...
  private static final int COUPONS_AMOUNT_AFTER_SENT =
      9; // The number of coupons should be one less
  ...
  @TmsLink("9500 & 9502")
  @Description(
      "\"Sorry!\" message is displayed and \"GIFT TO A FRIEND\" button is not clickable"
  ...
  public void noCouponsDisplayTest() {
    ...
    assertFalse(
        welcomeFlow.isGiftToAFriendBtnClickable(), "\"Gift to a friend button\" is clickable");
  ...
  @TmsLink("9504")
  @Description(
      "The carousel has maximum ten dots and \"View all\" button is displayed if there are at least ten coupons")
  @Test
  public void viewAllCouponsBtnAndCarouselTest() {
    ...
    welcomeFlow.swipeToCouponsSection();
    assertTrue(
        welcomeFlow.isGiftToAFriendBtnClickable(), "\"Gift to a friend button\" is not clickable");
    assertTrue(welcomeFlow.isViewAllCouponsBtnDisplayed(), "\"View\" all is  not displayed");
    assertEquals(
        welcomeFlow.couponsCarouselQuantity(),
        COUPONS_AMOUNT,
        "The number of available coupons and coupons in the carousel is not equal");
