...
@ContextConfiguration(
    classes = MobileContextConfig.class,
...
public class BaseTest extends AbstractTestNGSpringContextTests {
  ...
  /**
   * Print a log message when a test case is completed. Including whether it passed or failed. If
   * the test failed also print the exception that caused the failure.
   *
