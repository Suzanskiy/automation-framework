...
public class PopUpVipTest extends BaseTest {
  ...
  @Autowired PopupCloserFlow popupCloserFlow;
  ...
  @TmsLink("6409")
  @Description(
      "User is redirected to RaceTrac site on RaceTrac Rewards VIP tab after click Learn More")
  @Test
  public void redirectionAfterLearnMoreBtn() {
  ...
  @TmsLink("6413")
  @Description(
      "User is redirected to RaceTrac site on Confirm/Edit Account page after click Get Started page")
  @Test
